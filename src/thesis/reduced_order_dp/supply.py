...
import numpy as np
import math
from thesis.reduced_order_dp.control import DPpolePlacement
from thesis.reduced_order_dp.gnc import sat
...
class SupplyVessel:
    ...
    def __init__(
        ...
        self.L_underwater = self.L  # underwater length (m)
        self.x_cog = 0.0  # body-frame x of COG (m)
    ...
    def dynamics(
        ...
        nu3_dot = np.matmul(self.M3inv, tau3 + f_external - np.matmul(self.D3, nu3_r))
